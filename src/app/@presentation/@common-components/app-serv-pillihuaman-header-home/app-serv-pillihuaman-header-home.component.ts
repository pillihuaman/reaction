...
import { NbButtonModule, NbIconConfig, NbIconModule, NbLayoutModule, NbLayoutRulerService, NbSidebarModule, NbSidebarService, NbThemeModule, NbThemeService } from '@nebular/theme';

@Component({
  selector: 'app-app-serv-pillihuaman-header-home',
  standalone: true,
  imports: [MatFormFieldModule,
    ...
    NbSidebarModule,
    NbButtonModule,
    NbEvaIconsModule,NbIconModule,MatIconModule,MatNativeDateModule
  ],
  templateUrl: './app-serv-pillihuaman-header-home.component.html',
  styleUrl: './app-serv-pillihuaman-header-home.component.scss'
})

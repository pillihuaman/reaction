...
export const CoreImports = [RouterOutlet,
  ...
  NbSelectModule,NbIconModule,NbEvaIconsModule,MatIconModule,AppServPillihuamanFooterHomeComponent,ServPillihuamanHeaderHomeComponent,ServPillihuamanSidebarHomeComponent
];
